function [p, h] = doMatrixSignrank(dataIn, tail)
% [p, h] = doMatrixSignRank(dataIn, tail)
% --------------------------------------------
% Blair - April 4, 2016
...
% console.
%
% Outputs: p is the vector of p-values. h is the returns.
...
for i = 1:nObs
    [p(i), h(i)] = signrank(dataIn(i,:), 0, 'tail', theTail);
end